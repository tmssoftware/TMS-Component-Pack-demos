object Form252: TForm252
  Left = 0
  Top = 0
  ActiveControl = AdvSmoothStepControl1
  BorderStyle = bsDialog
  Caption = 'TMS Advanced Step Control Demo'
  ClientHeight = 477
  ClientWidth = 769
  Color = clBtnFace
  ...
  object AdvSmoothStepControl2: TAdvSmoothStepControl
    Left = 8
    Top = 315
    Width = 745
    Height = 126
    ...
    Appearance.ActiveAppearance.BackGroundFill.Color = 1048516
    Appearance.ActiveAppearance.BackGroundFill.ColorTo = 62134
    Appearance.ActiveAppearance.BackGroundFill.ColorMirror = 62134
    Appearance.ActiveAppearance.BackGroundFill.ColorMirrorTo = 52377
    ...
    Appearance.ActiveAppearance.BackGroundFill.HatchStyle = HatchStyleBackwardDiagonal
    ...
    Appearance.InActiveAppearance.BackGroundFill.Color = 57256
    Appearance.InActiveAppearance.BackGroundFill.ColorTo = 43648
    Appearance.InActiveAppearance.BackGroundFill.ColorMirror = clNone
    Appearance.InActiveAppearance.BackGroundFill.ColorMirrorTo = clNone
    ...
    Appearance.SeparatorFill.Color = 6723891
    Appearance.SeparatorFill.ColorTo = clGreen
    Appearance.SeparatorFill.ColorMirror = clNone
    Appearance.SeparatorFill.ColorMirrorTo = clNone
    Appearance.SeparatorFill.GradientType = gtVertical
    Appearance.SeparatorFill.GradientMirrorType = gtVertical
    Appearance.SeparatorFill.BorderColor = clBlack
    Appearance.SeparatorFill.Rounding = 0
    Appearance.SeparatorFill.ShadowOffset = 0
    Appearance.SeparatorFill.Glow = gmNone
    Appearance.SeparatorWidth = 7
    Appearance.DescriptionFill.Color = 1048516
    Appearance.DescriptionFill.ColorTo = 62134
    Appearance.DescriptionFill.ColorMirror = 62134
    Appearance.DescriptionFill.ColorMirrorTo = 52377
    Appearance.DescriptionFill.GradientType = gtSolid
    Appearance.DescriptionFill.GradientMirrorType = gtVertical
    Appearance.DescriptionFill.HatchStyle = HatchStyleBackwardDiagonal
  ...
  object AdvSmoothStepControl1: TAdvSmoothStepControl
    ...
    StepActions = <
      item
        ...
        InActiveContent.Caption = 'Step 1'
