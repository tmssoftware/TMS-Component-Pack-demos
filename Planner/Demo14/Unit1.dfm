object Form1: TForm1
  ...
  object Label1: TLabel
    ...
    Height = 13
    Caption = 
      'Max. selectable days is set with the PositionProps MaxSelection ' +
      'property'
  end
  object Planner1: TPlanner
    ...
    Version = '3.0.2.2'
    OnItemMoving = Planner1ItemMoving
  end
end
