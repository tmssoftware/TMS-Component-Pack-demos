object Form1: TForm1
  Left = 704
  Top = 254
  Caption = 'Drag & drop from header to planner grid'
  ClientHeight = 565
  ClientWidth = 678
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Height = 13
    Caption = 
      'Press ctrl drag the item with its trackbar to and from the heade' +
      'r'
  end
