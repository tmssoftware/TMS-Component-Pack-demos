object Form1: TForm1
  Left = 663
  Top = 227
  Caption = 'TPlanner custom time demo'
  ClientHeight = 601
  ClientWidth = 757
  Color = clBtnFace
  ...
  object Planner1: TPlanner
    ...
    Mode.PlannerType = plCustomList
    Mode.TimeLineStart = 38074.000000000000000000
    Mode.TimeLineNVUBegin = 0
    Mode.TimeLineNVUEnd = 0
    Mode.Year = 2004
    Mode.Day = 11
    Sidebar.DateTimeFormat = 'hh:nn'
