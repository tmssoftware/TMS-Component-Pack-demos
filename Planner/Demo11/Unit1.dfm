object Form1: TForm1
  ...
  object Label2: TLabel
    ...
    Width = 231
    Height = 13
    Caption = 'Drag & drop events from the wait list to the planner'
  end
  object Planner1: TPlanner
    ...
    Mode.TimeLineStart = 37938.000000000000000000
