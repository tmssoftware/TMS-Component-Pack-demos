object Form1: TForm1
  ...
  object Label1: TLabel
    ...
    Height = 13
    Caption = 
      'Press Insert to create an event. Creating overlapping events is ' +
      'disabled and will show a warning message.'
  end
  object DBPlanner1: TDBPlanner
    ...
    Display.CurrentPosFrom = 38141
    Display.CurrentPosTo = 38141
  ...
  object ADOTable1: TADOTable
    ConnectionString = 
      ...
      '\Demos\DBPlanner\Demos\Demo21\dbplanner.mdb;Persist Security Inf' +
      'o=False'
    CursorType = ctStatic
    TableName = 'Schedules'
    Left = 552
