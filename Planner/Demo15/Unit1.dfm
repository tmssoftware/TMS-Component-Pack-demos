object Form1: TForm1
  Left = 616
  Top = 227
  Caption = 'Planner Outlook import & export'
  ClientHeight = 600
  ClientWidth = 665
  Color = clBtnFace
  ...
  object Label2: TLabel
    ...
    Width = 106
    Height = 13
    Caption = 'Items found in Outlook'
  end
  object Label3: TLabel
    ...
    Width = 241
    Height = 13
    Caption = 'Create / delete items with selection && INS/DEL key'
  end
  ...
  object Button2: TButton
    ...
    Width = 169
    Height = 25
    Caption = 'Export selected item to Outlook'
    TabOrder = 3
